...
import todo from "../assets/projects/fullstack-todo.png";
import imageSearch from "../assets/projects/picture-gallery.png";
import passwordGen from "../assets/projects/passwordGen.png";
import hoobank from "../assets/projects/hoobank-landing-page.png";
import blogApp from "../assets/projects/blog-app.png";
import nirvanaMusic from "../assets/projects/nirvaana-music.png";
...
const Projects = () => {
  ...
  const projects = [
...

    {
      ...
      date: "2024",
      description: "A sleek landing page for a fictional banking service.",
      link: "https://hoobank-six-zeta.vercel.app/",
      image: hoobank,
    },
    {
      title: "Blog App",
      date: "2024",
      description:
        "A modern blog application with a clean and responsive design.",
      // link:"https://blog-app-kohl.vercel.app/",
      image: blogApp,
    },
    {
      title: "Nirvana Music",
      date: "2024",
      description: "A music streaming app inspired by Nirvana's aesthetic.",
      link: "https://the-nirvana-music-app-fe.vercel.app/",
      image: nirvanaMusic,
    },
    {
      ...
      >
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <div className="text-[16px] mb-[4px] font-bold text-center text-light-primary dark:text-cyan-400">
              PROJECTS
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10 w-full mt-2 overflow-y-auto max-h-[50vh] pr-2 custom-scrollbar">
            {projects?.map((project, index) => {
              return (
                ...
                >
                  <div
                    className={`overflow-hidden rounded-[16px] mb-3 shadow-lg transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-xl ${
                      darkMode
                  ...
                  >
                    <img
                      className="h-[180px] md:h-[200px] w-full object-cover transition-transform duration-500 group-hover:scale-110"
                      src={project?.image}
                      alt={project?.title}
                    />
                  </div>
                  <div className="text-[18px] md:text-[20px] font-bold mb-1 group-hover:text-cyan-500 transition-colors duration-300">
                    {project?.title}
                  </div>
                  <div
                    className={`text-justify mb-2 text-sm md:text-[15px] ${darkMode ? "text-slate-300" : "text-gray-600"}`}
                  >
                    {project?.description}
                  </div>
                  <div
                    className={`text-[12px] md:text-[13px] font-medium ${darkMode ? "text-slate-400" : "text-gray-400"}`}
                  >
                    {project?.date}
                  </div>
                </motion.a>
